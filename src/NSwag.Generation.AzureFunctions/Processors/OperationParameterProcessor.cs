...
using NSwag.Generation.AzureFunctions.ProcessorUtils;
...
namespace NSwag.Generation.AzureFunctions.Processors
{
    ...
    public class OperationParameterProcessor : IOperationProcessor
    {
        ...
        private AzureFunctionsOpenApiDocumentGeneratorSettings _settings;

        public OperationParameterProcessor(AzureFunctionsOpenApiDocumentGeneratorSettings settings)
        {
            _settings = settings;
        }
